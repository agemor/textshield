 ...
 * @author HyunJun Kim
 * @license MIT
 */e.Sha256=i,e.default=i},function(t,e,r){"use strict";var n=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});var o=n(r(0)),i=n(r(7)),a=function(){function t(){}return t.encrypt=function(t,e){return o.default.encode(i.default.encode(this.encode(t,e)))},t.decrypt=function(t,e){return this.encode(i.default.decode(o.default.decode(t)),e)},t.encode=function(t,e){var r="";e=this.trimKey(e,t.length);for(var n=0;n<t.length;n++)r+=String.fromCharCode(t.charCodeAt(n)^e.charCodeAt(n));return r},t.trimKey=function(t,e){if(t.length>e)t=t.substring(0,e);else for(var r=t.length;r<e;r++)t+=t.charAt(r-t.length);return t},t}();e.XorCipher=a,e.default=a},function(t,e,r){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var n=function(){function t(t,e,r){this.salt=t,this.lock=e,this.message=r}return t.prototype.toString=function(){return this.salt+this.lock+this.message},t.parse=function(e,r,n){return void 0===r&&(r=16),void 0===n&&(n=44),e.length<=r+n?null:new t(e.slice(0,r),e.slice(r,r+n),e.slice(r+n))},t}();e.EncodedMessage=n,e.default=n},function(t,e,r){"use strict";var n=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});var o=n(r(5)),i=n(r(12));e.Encoder=i.default;var a=n(r(6));e.Decoder=a.default;var u=n(r(3));e.EncodedMessage=u.default;var s=n(r(8));e.TextDisplay=s.default,window.TextShieldEncoder=new i.default,window.onload=function(){new o.default(document.body,null)},e.default=o.default},function(t,e,r){"use strict";var n=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});var o=n(r(6)),i=n(r(3)),a=n(r(8)),u=n(r(11)),s=function(){function t(t,e){this.body=t,this.decoder=new o.default,this.initialize()}return t.prototype.initialize=function(){for(var t=0,e=this.getShieldedElements();t<e.length;t++){var r=e[t],n=i.default.parse(r.textContent),o=(r.getAttribute("mode")||"normal").toLowerCase().trim();if(n){var s=this.decoder.decode(n);if("plain"==o)r.textContent=s;else{var f=new u.default(window.getComputedStyle(r)),c=new a.default(s,f);r.parentNode.replaceChild(c.getCanvas(),r),"distort"==o&&c.applyDistortion()}}}},t.prototype.getShieldedElements=function(){var t=this.body.getElementsByTagName("shield");return Array.prototype.slice.call(t)},t}();e.TextShield=s,e.default=s},function(t,e,r){"use strict";var n=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{value:!0});var o=n(r(1)),i=n(r(2)),a=function(){function t(){}return t.prototype.decode=function(t){var e=this.resolveHash(t.salt,t.lock);if(e<0)return null;var r=t.salt+e,n=this.reverseString(r);return i.default.decrypt(t.message,n)},t.prototype.resolveHash=function(e,r){for(var n=0;n<t.MAX_ATTEMPTS;){if(o.default.hash(e+n)==r)return n;n++}return-1},t.prototype.reverseString=function(t){return t.split("").reverse().join("")},t.MAX_ATTEMPTS=3e3,t}();e.Decoder=a,e.default=a},function(t,e,r){"use strict";Object.defineProperty(e,"__esModule",{value:!0});
/**
 * Basic Utf-8 encoder
 *
 * @version 1.0.0
